...
train_df=pd.read_csv("C:\\Users\\vj0805\\Desktop\\train1.csv")
test_df=pd.read_csv("C:\\Users\\vj0805\\Desktop\\test1.csv")
...
knn = KNeighborsClassifier(algorithm='auto', leaf_size=26, metric='minkowski', metric_params=None, n_neighbors=6, p=2, weights='uniform')
knn.fit(X, y)
y_pred = knn.predict(X_test)

temp = pd.DataFrame(pd.read_csv("C:\\Users\\vj0805\\Desktop\\test1.csv")['PassengerId'])
temp['Survived'] = y_pred
temp.to_csv("titanic7.csv", index = False)